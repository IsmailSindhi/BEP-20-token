...
contract Token {
    ...
    constructor() {
        name = "Nexus Galaxy"; // Sets the name of the token, i.e Ether
        symbol = "NSX"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 200000000; // Holds an initial supply of coins

        /* Sets the owner of the token to whoever deployed it */
        owner = payable(msg.sender);

        // totalSupply = _initialSupply; // Sets the total supply of tokens
        totalSupply = 1000000000; // Sets the total supply of tokens
